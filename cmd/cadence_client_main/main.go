...
import (
	...
	cadenceclient "github.com/cadence-workflow/starlark-worker/client/cadence_client"
...
func __run__(_args []string) {
	...
	if err := cadenceclient.Run(_tar, file, function, argsP, kwargsP, _env, cadenceCli, tasklist); err != nil {
		log.Fatal(err)
	}
}
